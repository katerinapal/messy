...
import {
    RequestLine as RequestLine_RequestLine,
    propertyNames as RequestLinejs_propertyNames,
} from "./RequestLine";
...
HttpRequest.propertyNames = Message_Message.propertyNames.concat(HttpRequest.metadataPropertyNames).concat(RequestLinejs_propertyNames).concat(['requestLine']);
...
RequestLinejs_propertyNames.forEach(function (requestLinePropertyName) {
