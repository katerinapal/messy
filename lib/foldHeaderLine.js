...
var mod_anonymus = function foldHeaderLine(str, maxLength, firstLineMaxLength) {
...
exports.foldHeaderLine = mod_anonymus = function foldHeaderLine(str, maxLength, firstLineMaxLength) {
    maxLength = maxLength || 78;
    firstLineMaxLength = firstLineMaxLength || maxLength;
    if (str.length <= firstLineMaxLength) {
        return str;
...
exports.foldHeaderLine = mod_anonymus;