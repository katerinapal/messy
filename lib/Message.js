        ...
        if (!isDefined(this._unchunkedBody)) {
            if (isDefined(this._rawBody)) {
                ...
                if (transferEncoding && transferEncoding === 'chunked') {
                    try {
                        this._unchunkedBody = (0, _decodeChunkedTransferEncoding.decodeChunkedTransferEncoding)(this._unchunkedBody);
                    } catch (e) {}
                }
...
function isNonBufferNonRegExpObject(obj) {
    return obj && (typeof obj === "undefined" ? "undefined" : _typeof(obj)) === 'object' && (typeof Buffer === 'undefined' || !Buffer.isBuffer(obj)) && !(0, _isRegExp.isRegExp)(obj);
}
