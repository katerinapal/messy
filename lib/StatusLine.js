...
var propertyNames;
var nonComputedPropertyNames;
function StatusLine(obj) {
    this.populate(obj);
}

nonComputedPropertyNames = ['protocolName', 'protocolVersion', 'statusCode', 'statusMessage'];
exports.propertyNames = propertyNames = ['protocol'].concat(nonComputedPropertyNames);
...
StatusLine.prototype.populate = function (obj) {
    ...
    } else if (obj && (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object' && !Buffer.isBuffer(obj)) {
...
StatusLine.prototype.toJSON = function () {
    var obj = {};
    nonComputedPropertyNames.forEach(function (propertyName) {
