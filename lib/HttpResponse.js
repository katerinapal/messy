...
import {
    StatusLine as StatusLine_StatusLine,
    propertyNames as StatusLinejs_propertyNames,
} from "./StatusLine";
...
HttpResponse.propertyNames = Message_Message.propertyNames.concat(StatusLinejs_propertyNames).concat(['statusLine']);
...
StatusLinejs_propertyNames.forEach(function (statusLinePropertyName) {
