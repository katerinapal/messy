...
var _quotedPrintable = require("quoted-printable");

var _quotedPrintable2 = _interopRequireDefault(_quotedPrintable);

var _decodeChunkedTransferEncoding = require("./decodeChunkedTransferEncoding");
...
Message.prototype.HeadersConstructor = _Headers.Headers;
...
Object.defineProperty(Message.prototype, 'unchunkedBody', {
        ...
        if (!isDefined(this._unchunkedBody)) {
            if (isDefined(this._rawBody)) {
                ...
                if (transferEncoding && transferEncoding === 'chunked') {
                    try {
                        this._unchunkedBody = (0, _decodeChunkedTransferEncoding.decodeChunkedTransferEncodingjs)(this._unchunkedBody);
                    } catch (e) {}
                }
            } else if (isDefined(this._body) || isDefined(this._parts)) {
                this._unchunkedBody = this.body;
                if ((this.isJson && typeof this._unchunkedBody !== 'undefined' || this._unchunkedBody && _typeof(this._unchunkedBody) === 'object') && (typeof Buffer === 'undefined' || !Buffer.isBuffer(this._unchunkedBody))) {
                    try {
                ...
                } else if (_iconvLite2.default.encodingExists(charset) && !/^utf-?8$/i.test(charset)) {
                    this._unchunkedBody = _iconvLite2.default.encode(this._unchunkedBody, charset);
                }
                ...
                if (contentTransferEncoding) {
                    ...
                    if (contentTransferEncoding === 'base64') {
                        ...
                        this._unchunkedBody = _quotedPrintable2.default.encode(this._unchunkedBody);
                    }
                }
    ...
    set: function set(unchunkedBody) {
        ...
        if (this._parts) {
            ...
            if (contentTransferEncoding) {
                ...
                if (contentTransferEncoding === 'quoted-printable') {
                    ...
                    var qpDecodedBodyAsByteString = _quotedPrintable2.default.decode(this._body);
            ...
            if (this.hasTextualContentType && contentTransferEncodingIsHonored && this._body && typeof this._body !== 'string') {
                var charset = this.charset;
                if (_iconvLite2.default.encodingExists(charset)) {
                    this._body = _iconvLite2.default.decode(this._body, charset);
                }
            }
...
function isNonBufferNonRegExpObject(obj) {
    return obj && (typeof obj === "undefined" ? "undefined" : _typeof(obj)) === 'object' && (typeof Buffer === 'undefined' || !Buffer.isBuffer(obj)) && !(0, _isRegExp.isRegExpjs)(obj);
}
...
Message.prototype.serialize = function (maxLineLength, forceString) {
    ...
    if (typeof this.body !== 'undefined') {
        result += '\r\n';
        if (this.body && _typeof(this.body) === 'object' && isNonBufferNonRegExpObject(this.body)) {
...
var exported_Message = Message;
exports.Message = exported_Message;
