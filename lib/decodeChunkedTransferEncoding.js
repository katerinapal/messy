...
var mod_anonymus = function decodeTransferEncodingChunked(body) {
    var chunks = [],
        index = 0,
        nextChunkLength,
        nextChunkLengthHex;
...
exports.decodeChunkedTransferEncoding = mod_anonymus = function decodeTransferEncodingChunked(body) {
    var chunks = [],
        index = 0,
        nextChunkLength,
        nextChunkLengthHex;
...
exports.decodeChunkedTransferEncoding = mod_anonymus;