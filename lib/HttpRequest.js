var mod_HttpRequest = HttpRequest;
...
function HttpRequest(obj) {
    this.requestLine = new RequestLine_RequestLine();
...
HttpRequest.propertyNames = Message_Message.propertyNames.concat(HttpRequest.metadataPropertyNames).concat(RequestLine_RequestLine.propertyNames).concat(['requestLine']);

ext_util_util.inherits(HttpRequest, Message_Message);
...
HttpRequest.prototype.populateFromObject = function (obj) {
    ...
    this.requestLine.populateFromObject(ext__.omit(obj, 'url'));
    return this;
};
...
HttpRequest.prototype.populateFromString = function (str) {
    ...
    if (matchRequestLine) {
        Message_Message.prototype.populateFromString.call(this, str.substr(matchRequestLine[0].length));
...
RequestLine_RequestLine.propertyNames.forEach(function (requestLinePropertyName) {
...
HttpRequest.prototype.toJSON = function () {
    return ext__.extend(Message_Message.prototype.toJSON.call(this), this.requestLine.toJSON());
};

export { mod_HttpRequest as HttpRequest };
