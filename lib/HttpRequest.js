...
HttpRequest.propertyNames = _Message.Message.propertyNames.concat(HttpRequest.metadataPropertyNames).concat(_RequestLine.propertyNames).concat(['requestLine']);
...
_RequestLine.propertyNames.forEach(function (requestLinePropertyName) {
...
exports.HttpRequest = mod_HttpRequest;