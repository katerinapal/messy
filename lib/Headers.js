...
var _rfc = require("rfc2231");

var _rfc2 = _interopRequireDefault(_rfc);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var formatHeaderName_formatHeaderNamejsBinding = {};
...
Headers.prototype.set = function (headerName, valueOrValues, valueNumber) {
    if (headerName && (typeof headerName === "undefined" ? "undefined" : _typeof(headerName)) === 'object') {
...
Headers.prototype.remove = function (headerNameOrObj, valueOrValuesOrValueNumber) {
    var numRemoved = 0;
    if (headerNameOrObj && (typeof headerNameOrObj === "undefined" ? "undefined" : _typeof(headerNameOrObj)) === 'object') {
    ...
    if (typeof stringOrArrayOrRegExp === 'undefined') {
        ...
        if (Array.isArray(stringOrArrayOrRegExp)) {
            return stringOrArrayOrRegExp.every(function (expectedValue) {
                if ((0, _isRegExp.isRegExpjs)(expectedValue)) {
...
Headers.prototype.parameter = function (headerName, attributeName, attributeValue) {
    ...
    if (headerValue) {
        ...
        if (usesRfc2231 && !rfc2231DisabledForThisHeader) {
            parameters = _rfc2.default.unfoldAndDecodeParameters(parameters);
        }
        if (attributeName) {
            if (attributeValue) {
                ...
                if (!rfc2231DisabledForThisHeader) {
                    parameters = _rfc2.default.encodeAndFoldParameters(parameters);
                }
...
Headers.prototype.toString = function (maxLineLength) {
    ...
    lowerCaseHeaderNames.forEach(function (lowerCaseHeaderName) {
        this.valuesByName[lowerCaseHeaderName].forEach(function (value) {
            result += (0, _formatHeaderName.formatHeaderName)(lowerCaseHeaderName) + ': ' + (0, _foldHeaderLine.foldHeaderLinejs)(this.serializeHeaderValue(value), maxLineLength, maxLineLength - lowerCaseHeaderName.length - 2) + '\r\n';
        }, this);
    }, this);
    return result;
};
...
Headers.prototype.toCanonicalObject = function () {
    ...
    this.getNames().forEach(function (lowerCaseHeaderName) {
        canonicalObject[(0, _formatHeaderName.formatHeaderName)(lowerCaseHeaderName)] = this.getAll(lowerCaseHeaderName);
    }, this);
...
Headers.prototype.toJSON = function () {
    ...
    this.getNames().forEach(function (lowerCaseHeaderName) {
        ...
        if (values.length === 1) {
            obj[(0, _formatHeaderName.formatHeaderName)(lowerCaseHeaderName)] = this.get(lowerCaseHeaderName);
        } else {
            obj[(0, _formatHeaderName.formatHeaderName)(lowerCaseHeaderName)] = this.getAll(lowerCaseHeaderName);
        }
    }, this);
    return obj;
};

var exported_Headers = Headers;
exports.Headers = exported_Headers;
