var mod_HttpExchange = HttpExchange;
...
function HttpExchange(obj) {
    ...
    if (typeof obj.request !== 'undefined') {
        this.request = obj.request instanceof HttpRequest_HttpRequest ? obj.request : new HttpRequest_HttpRequest(obj.request);
    }
    if (typeof obj.response !== 'undefined') {
        this.response = obj.response instanceof HttpResponse_HttpResponse ? obj.response : new HttpResponse_HttpResponse(obj.response);
    }
}
...
export { mod_HttpExchange as HttpExchange };
