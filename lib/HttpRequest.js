...
util.inherits(HttpRequest, Message_Messagejs);
...
HttpRequest.prototype.toJSON = function () {
    return _.extend(Message_Messagejs.prototype.toJSON.call(this), this.requestLine.toJSON());
};

var exported_HttpRequest = HttpRequest;
export { exported_HttpRequest as HttpRequest };
