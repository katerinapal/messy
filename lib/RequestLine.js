...
nonComputedPropertyNames = ['method', 'url', 'protocolName', 'protocolVersion'];
exports.propertyNames = propertyNames = ['protocol', 'path', 'search', 'query'].concat(nonComputedPropertyNames);

RequestLine.prototype.isMessyRequestLine = true;

RequestLine.prototype.populate = function (obj) {
    if (obj && (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object' && !Buffer.isBuffer(obj)) {
