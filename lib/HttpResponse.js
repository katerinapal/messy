...
HttpResponse.propertyNames = _Message.Message.propertyNames.concat(_StatusLine.propertyNames).concat(['statusLine']);
...
_StatusLine.propertyNames.forEach(function (statusLinePropertyName) {
