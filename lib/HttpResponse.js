...
util.inherits(HttpResponse, Message_Messagejs);
...
HttpResponse.prototype.toJSON = function () {
    return _.extend(Message_Messagejs.prototype.toJSON.call(this), this.statusLine.toJSON());
};

var exported_HttpResponse = HttpResponse;
export { exported_HttpResponse as HttpResponse };
